...
export { MemoryStore, isSampledIn, resolveIdentity, uuidv4, type KeyValueStore } from './session.js';
export { diff, serialise, tagFor, isMaskedByDefault, type CapturedElement, type Rect } from './tree.js';
